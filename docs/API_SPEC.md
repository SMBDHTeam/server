  ...
  "items": [
    {
      ...
      "themeName": "남파랑길",
      "lineMessage": "남쪽의 쪽빛 바다와 함께 걷는 길",
      "description": "남해안을 따라 연결된 걷기 여행길",
      "brdDiv": "DNWW",
      "source": "DURUNUBI"
    }
  ]
...
외부 원본 응답의 주요 필드는 `routeIdx`, `themeNm`, `linemsg`, `themedescs`, `brdDiv`다.
...
외부 원본 응답의 주요 필드는 `routeIdx`, `crsIdx`, `crsKorNm`, `crsDstnc`, `crsTotlRqrmHour`, `crsLevel`, `crsCycle`, `crsContents`, `crsSummary`, `crsTourInfo`, `travelerinfo`, `sigun`, `gpxpath`, `brdDiv`다.
