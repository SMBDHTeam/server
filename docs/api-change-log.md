...
`GET /api/v1/notifications`, `GET /notifications/unread-count`, `PATCH /notifications/{id}/read`, `PATCH /notifications/read-all` 네 개다. `V10__create_notifications_table.sql`로 `notifications` 테이블과 인덱스 둘을 추가한다.
