    ...
    private static Stream<Arguments> spontaneousErrors() {
        return Stream.of(
                ...
                Arguments.of(ErrorCode.SPONTANEOUS_COURSE_RETURN_TIME_EXCEEDED, 422,
                        "선택한 이동수단으로는 설정한 복귀 시간 안에 돌아오기 어렵습니다. 이동수단을 변경하거나 더 가까운 목적지를 선택해 주세요."),
                Arguments.of(ErrorCode.SPONTANEOUS_COURSE_THEME_NOT_FEASIBLE, 422,
                        "선택한 지역에서는 요청한 테마를 모두 포함한 코스를 만들기 어렵습니다. 테마를 줄이거나 다른 목적지를 선택해 주세요."),
                Arguments.of(ErrorCode.SPONTANEOUS_COURSE_PLACES_CLOSED, 422,
