...
public enum ErrorCode {
    ...
    SPONTANEOUS_TIME_INVALID(400, "출발 및 복귀 시간 정보를 확인해 주세요."),
    SPONTANEOUS_TIMEZONE_REQUIRED(400, "날짜와 시간 정보를 다시 선택해 주세요."),
    SPONTANEOUS_START_DATE_NOT_TODAY(400, "즉흥여행은 오늘 출발하는 일정만 만들 수 있습니다."),
    SPONTANEOUS_START_TIME_IN_PAST(400, "출발 시간이 현재 시각보다 이전입니다. 출발 시간을 다시 선택해 주세요."),
    SPONTANEOUS_RETURN_TIME_BEFORE_START(400, "복귀 시간은 출발 시간보다 늦어야 합니다."),
    SPONTANEOUS_RETURN_TIME_TOO_LATE(400, "복귀 시간은 출발일 기준 다음 날 오전 3시까지 설정할 수 있습니다."),
    SPONTANEOUS_START_LOCATION_REQUIRED(400, "출발 위치를 설정해 주세요."),
    SPONTANEOUS_START_LOCATION_INVALID(400, "출발 위치를 확인할 수 없습니다. 위치를 다시 설정해 주세요."),
    SPONTANEOUS_START_LOCATION_OUTSIDE_BUSAN(400, "부산 지역 안의 출발 위치를 선택해 주세요."),
    SPONTANEOUS_TRANSPORT_MODE_REQUIRED(400, "이동수단을 선택해 주세요."),
    SPONTANEOUS_TRANSPORT_MODE_INVALID(400, "지원하지 않는 이동수단입니다. 이동수단을 다시 선택해 주세요."),
    SPONTANEOUS_THEME_INVALID(400, "선택한 테마 정보를 확인해 주세요."),
    SPONTANEOUS_THEME_LIMIT_EXCEEDED(400, "테마는 최대 3개까지 선택할 수 있습니다."),
    ...
    SPONTANEOUS_DESTINATION_ROUTE_NOT_FOUND(404, "선택한 이동수단으로 갈 수 있는 목적지를 찾지 못했습니다. 이동수단을 변경해 주세요."),
    SPONTANEOUS_DESTINATION_TIME_TOO_SHORT(404, "현재 여행 가능 시간으로는 왕복 이동과 최소 체류시간을 확보하기 어렵습니다. 복귀 시간을 늦추거나 이동수단을 변경해 주세요."),
    SPONTANEOUS_DESTINATION_TRANSPORT_CONSTRAINT(404, "선택한 이동수단과 남은 시간으로 다녀올 수 있는 목적지가 없습니다. 이동수단을 변경하거나 복귀 시간을 늦춰 주세요."),
    SPONTANEOUS_DESTINATION_CANDIDATES_NOT_FOUND(404, "선택한 테마에 맞는 목적지를 찾지 못했습니다. 테마를 줄이거나 변경해 주세요."),
    ...
    SPONTANEOUS_PROCESSING_ERROR(502, "즉흥여행 정보를 처리하지 못했습니다. 잠시 후 다시 시도해 주세요."),
    SPONTANEOUS_PROVIDER_ERROR(502, "여행 정보 제공 서비스 처리 중 오류가 발생했습니다. 잠시 후 다시 시도해 주세요."),
    SPONTANEOUS_PROVIDER_UNAVAILABLE(503, "여행 정보를 불러오는 서비스가 일시적으로 원활하지 않습니다. 잠시 후 다시 시도해 주세요."),
